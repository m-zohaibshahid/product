    ...
    <div className="p-8 max-w-7xl mx-auto space-y-12 animate-fade-in">
      {!selectedOrder ? (
        <div className="space-y-12">
          ...
          {/* Logistics Tabs */}
          <div className="flex gap-4 border-b border-zinc-100 dark:border-gray-500/30 pb-0 shadow-[0_1px_0_0_rgba(0,0,0,0.05)]">
             <button 
          ...
          {/* Master PO List */}
          <div className="bg-white dark:bg-gray-500 rounded-[40px] border border-zinc-100 dark:border-gray-500/30 shadow-xl overflow-hidden">
             <div className="p-10 border-b border-zinc-50 dark:border-gray-500/30 flex items-center justify-between gap-8">
                <div className="relative flex-1 max-w-xl">
                   ...
                   <input type="text" placeholder="Find by Vendor, PO# or Item..." className="w-full pl-14 pr-6 py-5 bg-zinc-50 dark:bg-gray-500 rounded-2xl border-none outline-none focus:ring-1 focus:ring-zinc-900 dark:focus:ring-blue-500 font-bold text-sm" />
                </div>
                <button className="flex items-center gap-2 px-6 py-3 bg-zinc-50 dark:bg-gray-500 text-zinc-900 dark:text-white rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-all font-bold text-xs uppercase tracking-widest">
                      ...
                      >
                         ...
                         <td className="px-10 py-10 text-center">
                            <div className="flex flex-col items-center">
                               <p className="text-sm font-black text-zinc-900 dark:text-white uppercase tracking-tight">{item.delivery}</p>
                         ...
                         <td className="px-10 py-10 text-center">
                            <div className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full border ${item.status === 'Completed' ? 'bg-green-50 text-green-600 border-green-100 dark:bg-green-900/10 dark:text-green-400' : item.status === 'In Transit' || item.status === 'Inbound' ? 'bg-blue-50 text-blue-600 border-blue-100 dark:bg-blue-900/10 dark:text-blue-400 animate-pulse' : 'bg-zinc-100 text-zinc-400 border-zinc-100 dark:bg-gray-500 dark:text-zinc-100'}`}>
        ...
        <div className="max-w-[1400px] mx-auto animate-slide-in pb-20 space-y-12">
           <div className="flex items-center justify-between">
              ...
              >
                <div className="w-10 h-10 rounded-full bg-white dark:bg-gray-500 border border-zinc-100 dark:border-zinc-700 flex items-center justify-center group-hover:bg-zinc-900 group-hover:text-white transition-all shadow-sm"><ArrowLeft className="w-4 h-4" /></div>
                Back to Ledger
              </button>
              <div className="flex gap-4">
                 <button className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-gray-500 border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-white rounded-2xl font-bold text-xs uppercase tracking-widest hover:bg-zinc-50 transition-colors shadow-sm"><FileText className="w-4 h-4 opacity-40" /> PDF Manifest</button>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              ...
              <div className="lg:col-span-8 space-y-10">
                 <div className="bg-white dark:bg-gray-500 rounded-[48px] border border-zinc-100 dark:border-gray-500/30 shadow-2xl overflow-hidden">
                    <div className="bg-zinc-900 dark:bg-blue-900 p-12 md:p-16 text-white relative group overflow-hidden">
                       ...
                       <div className="relative z-10 space-y-6">
                          <div className="flex flex-wrap gap-3">
                             ...
                             <span className="px-4 py-1.5 bg-gray-500/30 text-white/60 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] border border-gray-500/30">PO REFERENCE: {selectedOrder.id}</span>
                          </div>
                          <h2 className="text-5xl md:text-7xl font-black italic-elegant tracking-tighter leading-none">{selectedOrder.vendor}</h2>
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-6 border-t border-gray-500/30">
                             <div>
                    ...
                    <div className="p-12 space-y-10">
                       <h3 className="text-xs font-bold uppercase tracking-widest text-zinc-400 flex items-center gap-2 border-b border-zinc-50 dark:border-gray-500/30 pb-6"><Package className="w-4 h-4 text-zinc-900 dark:text-white" /> Manifest Details</h3>
              ...
              <div className="lg:col-span-4 space-y-10">
                 <div className="bg-white dark:bg-gray-500 rounded-[40px] border border-zinc-100 dark:border-gray-500/30 shadow-xl p-10 space-y-10">
                    <div>
                       <h3 className="text-xs font-bold uppercase tracking-widest text-zinc-400 mb-8 flex items-center gap-2 border-b border-zinc-50 dark:border-gray-500/30 pb-6"><MapPin className="w-4 h-4 text-red-500" /> Delivery Target</h3>
                       <a 
                         href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(selectedOrder.address)}`}
                         target="_blank"
                         rel="noopener noreferrer"
                         className="p-6 bg-zinc-50 dark:bg-gray-500/50 rounded-[32px] border border-zinc-100 dark:border-zinc-700 flex items-center gap-4 group hover:bg-zinc-900 dark:hover:bg-blue-600 hover:text-white transition-all duration-500"
                      >
                    ...
                    <div className="pt-6 border-t border-zinc-50 dark:border-gray-500/30 space-y-6">
                       <div className="flex items-center gap-4">
                          <div className="w-10 h-10 bg-zinc-100 dark:bg-gray-500 rounded-xl flex items-center justify-center text-zinc-400"><Info className="w-5 h-5" /></div>
                          <div>
                 ...
                 <div className="bg-white dark:bg-gray-500 rounded-[40px] border border-zinc-100 dark:border-gray-500/30 shadow-xl p-10 space-y-10">
                    <h3 className="text-xs font-bold uppercase tracking-widest text-zinc-400 flex items-center gap-2 border-b border-zinc-50 dark:border-gray-500/30 pb-6"><History className="w-4 h-4" /> Transit History</h3>
