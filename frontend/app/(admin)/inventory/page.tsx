    ...
    <div className="space-y-12 animate-fade-in pb-20">
          ...
          <section className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-zinc-100 dark:border-gray-500/30 pb-10">
            ...
            <div className="flex gap-4">
               <button 
                 ...
                 className="flex items-center gap-2 px-6 py-3 bg-zinc-50 dark:bg-gray-500 text-zinc-600 dark:text-zinc-400 rounded-2xl hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-all font-bold text-xs uppercase tracking-widest"
               >
                    ...
                    <div className="bg-zinc-900 dark:bg-blue-900 p-12 md:p-16 text-white relative group">
                       ...
                       <div className="relative z-10 space-y-6">
                          <div className="flex flex-wrap gap-3">
                             ...
                             <span className="px-4 py-1.5 bg-gray-500/30 text-white/60 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] border border-gray-500/30">{selectedProduct.sku}</span>
                          </div>
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-zinc-900/40 backdrop-blur-xl animate-fade-in">
           <div className="bg-white dark:bg-gray-600 w-full max-w-2xl rounded-[48px] shadow-2xl border border-zinc-100 dark:border-gray-500/30 overflow-hidden relative animate-scale-in">
              <button 
                onClick={() => setShowAddModal(false)}
                className="absolute top-8 right-8 w-12 h-12 rounded-full bg-zinc-50 dark:bg-gray-500 flex items-center justify-center text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-all shadow-sm"
                 ...
                 <form onSubmit={handleAddProduct} className="space-y-8">
                    <div className="grid grid-cols-2 gap-6">
                       <div className="space-y-2">
                          ...
                          <input type="text" placeholder="e.g. Italian Silk" className="w-full bg-zinc-50 dark:bg-gray-500 p-5 rounded-2xl font-bold text-sm outline-none focus:ring-1 focus:ring-zinc-900 dark:focus:ring-blue-600 border-none transition-all dark:text-white" required />
                       </div>
                       <div className="space-y-2">
                          <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 block ml-1">Identification SKU</label>
                          <input type="text" placeholder="e.g. SKU-8821" className="w-full bg-zinc-50 dark:bg-gray-500 p-5 rounded-2xl font-bold text-sm outline-none focus:ring-1 focus:ring-zinc-900 dark:focus:ring-blue-600 border-none transition-all dark:text-white" required />
                       </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-6">
                       ...
                       <div className="space-y-2">
                          ...
                          <input type="text" placeholder="$0.00" className="w-full bg-zinc-50 dark:bg-gray-500 p-5 rounded-2xl font-bold text-sm outline-none border-none dark:text-white" />
                       </div>
                    </div>
