  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6 bg-background transition-colors duration-500">
      ...
      <div className="grid md:grid-cols-2 gap-10 w-full max-w-5xl animate-slide-in">
        <Link 
          href="/shop"
          className="group relative bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-[40px] p-12 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col items-center text-center shadow-sm"
        >
          <div className="w-24 h-24 bg-zinc-50 dark:bg-zinc-800 rounded-3xl flex items-center justify-center mb-10 group-hover:bg-blue-600 group-hover:rotate-12 transition-all duration-500">
          ...
          <div className="mt-auto flex items-center text-blue-600 font-black uppercase tracking-widest text-[10px]">
        ...
        <Link 
          ...
          className="group relative bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-[40px] p-12 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col items-center text-center shadow-sm"
        >
          <div className="w-24 h-24 bg-zinc-50 dark:bg-zinc-800 rounded-3xl flex items-center justify-center mb-10 group-hover:bg-zinc-900 dark:group-hover:bg-blue-600 group-hover:-rotate-12 transition-all duration-500 text-zinc-400 group-hover:text-white">
            <Settings className="w-10 h-10 transition-colors" />
          </div>
          <h2 className="text-2xl font-black text-zinc-900 dark:text-white mb-4 uppercase tracking-tighter">Atelier Ledger</h2>
          <p className="text-zinc-400 font-medium leading-relaxed mb-10 text-sm">
            Operational dashboard for master tailors. Control stock levels, inventory audits, and financial registries.
          </p>
          <div className="mt-auto flex items-center text-zinc-900 dark:text-zinc-100 font-black uppercase tracking-widest text-[10px]">
